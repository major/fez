...
- `capabilities/` - the actual commands fez runs (e.g. `services`, `packages`, `network`); `capability/` holds machine-readable descriptors of that surface
